...
import com.example.tieuluan.AddStudent;
import com.example.tieuluan.EditStudentActivity;
...
//        Khai báo TextView
        ...
        TextView tvFulName=view.findViewById(R.id.tvNameStudent);
        TextView tvAgeStudent=view.findViewById(R.id.tvAgeStudent);
        TextView tvStatusStudent=view.findViewById(R.id.tvStatusStudent);
...
//                imgPhotoStudent.setImageResourcee(student.getImage());
...
//                            thêm sinh viên vao Firebase
//                            mở màn hình mới
                            Intent intent=new Intent(activity, AddStudent.class);
